\section{Relaciones de equivalencia}\label{sec:equivalence}
  ...
  \begin{proof}
    ...
    primera característica de $s$:
      ...
      \item[$s=\f{A}s_1$.] En este caso existe $p_1,q\in(0,1)$
        ...
        \end{itemize}
        % \item[$s=\f{B}s_1$.] In this case  is $p_1,q\in(0,1)$
        %   such that $P\tranp{\f{B}}{p_1}P_1\vtranp{s_1\checkmark}{q}\nil$. 
        %   By applying Rule~\nombreRegla{req3}, we obtain
        %   $$
        %   \require{A}{B}{P}\tranp{\f{B}}_{p_1}P_1\vtranp{s_1\checkmark}{q}\nil
        %   $$
      \item[$s=\f{C}s_1$ con $\f{C}\neq\f{A}$.]
