...
term
$P=\feature{A};\checkmark \choice_{\frac12} \feature{A};\checkmark$. If we were not careful, we would have
the transition $P\tranp{\feature{A}}\nobreak{\frac12}\checkmark$ only once, while we
