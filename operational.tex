...
\begin{figure*}[t]
        ...
        \nombreRegla{cho1} & \displaystyle \frac{P\tranp{a}{p} P_1}{P\choice_{q} Q\tranp{a}{p\cdot q} P_1}&
        ...
        \frac{P \tranp{a}{p} P_1,\ a\neq\feature{A}}{\forbid{A}{P}
                \tranp{a}{p} \forbid{A}{P_1}} \\
        % \nombreRegla{forb2} & \displaystyle
        % \frac{P \tranp{\checkmark}{p} \nil}{\forbid{A}{P}
        %         \tranp{\checkmark}{p} \nil}  \\
        %      \Nombreregla{forb3} & \displaystyle
...
The rules in Figure~\ref{fig:sos-rules} define the behavior of
\fodaPAp\ terms.
...
Instead, the $\choice_{p}$ is not symmetric, which makes impossible for
