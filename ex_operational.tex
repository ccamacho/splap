...
%         \node[isosceles triangle, shape border rotate=90] (C21) [below=0cm of C2] {
%           \begin{minipage}{1cm}
%             {\footnotesize (2)} in\\Figure~\ref{example:op1}
%           \end{minipage}
% };
        ...
        [below=0.1cm of D] {\parbox{3cm}{\centering Similar to\\ $\fA;\checkmark\paral(\checkmark\paral
            \fC;\checkmark)$}};
        \node[syntax] (C41) [below left=1cm and -1cm of C4]{$\checkmark\paral\checkmark$};
        \node[syntax] (C42) [below right=1cm and 0cm of C4]{$\checkmark$};
        \node[syntax] (C411) [below=1cm of C41] {$\nil$};
        \node[syntax] (C421) [below=1cm of C42] {$\nil$};

        \node[syntax] (C31) [below left=1cm and -1cm of C3]{$\checkmark\paral\checkmark$};
        \node[syntax] (C32) [below right=1cm and -0.5cm of C3]{$\checkmark$};
        \node[syntax] (C311) [below=1cm of C31] {$\nil$};
        \node[syntax] (C321) [below=1cm of C32] {$\nil$};
        ...
        (C421);
        \path
        (C4) edge[->] node[left, opacity=0, text opacity=1]
        {$\feature{A},\frac{1}{2}$}
        (C41);
        \path
        (C4) edge[->] node[right, opacity=0, text opacity=1]
        {$\feature{A},\frac{1}{2}$}
        (C42);
