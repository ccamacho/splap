  ...
  \centering
    \scalebox{0.6}{%
      \begin{tikzpicture}[->,>=stealth',node distance=1.5cm]
        ...
        \path (B) edge[->] node[above, opacity=0, text opacity=1]
        {$\fC,\frac{1}{4}$} (B1);
        ...
        {$\fC,\frac{1}{4}$} (B4);
        \path (D) edge[->] node[above, opacity=0, text opacity=1]
        {$\fB,\frac{1}{4}$} (D1);
  ...
  \begin{minipage}{.7\hsize}
    ...
    \scalebox{0.6}
    {
      \begin{tikzpicture}[->,>=stealth',node distance=1.5cm]
        ...
        \node[syntax] (C31) [below=1cm of C3]{$\checkmark\paral\checkmark$};
        \node[syntax] (C211) [below=1cm of C21] {$\nil$};
        \node[syntax] (C311) [below=1cm of C31] {$\nil$};
        ...
        %   (C21.south east);
        \path (C3) edge[->]
        node[right, opacity=0, text opacity=1]
        {$\feature{A},\frac{1}{2}$}
        (C31);
        \path (C31) edge[->]
        node[right, opacity=0, text opacity=1]
        ...
        (D);
        \path
        (C) edge[->] node[above, opacity=0, text opacity=1]
        {$\feature{A},\frac{1}{2}$}
        (C1);
        \path
  ...
  \begin{minipage}{0.4\hsize}
    ...
    \scalebox{0.62}{
      \begin{tikzpicture}[->,>=stealth',node distance=1.5cm]
        ...
        \node[syntax] (F1) [below=1.5cm of F]   {$\checkmark$};

        \node[syntax] (I) [below left=1.5cm and 0cm of G]   {$\checkmark\paral\checkmark$};
        \node[syntax] (I1) [below right=1.5cm and -0.5cm of G]   {$\checkmark$};
        \node[syntax] (I11) [below=1.5cm of I1]   {$\nil$};
        \node[syntax] (J) [below right=1.5cm and 1cm of G]
        {$\nil$};

        \node[syntax] (K) [below=1.5cm of F1]   {$\nil$};
        ...
        {$\feature{D},\frac{1}{2}$}
        (I)
        (G) edge[->] node[pos=0.5, right, opacity=0, text opacity=1]
        {$\feature{C},\frac{q}{2}$}
        (I)
        (G) edge[->] node[right, pos=0.8, opacity=0, text opacity=1]
        {$\feature{C},\frac{q}{2}$}
        (I1)
        (I1) edge[->] node[right, opacity=0, text opacity=1]
        {$\checkmark,1$}
        (I11)
        (G) edge[->] node[right, opacity=0, text opacity=1]
        {$\checkmark,1-q$}
        (J)
        (F1) edge[->] node[right, opacity=0, text opacity=1]
        {$\checkmark,1$}
        (K)
