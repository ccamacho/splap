  ...
  \centering
    \scalebox{0.6}{%
      \begin{tikzpicture}[->,>=stealth',node distance=1.5cm]
        ...
        \node [above left=-.2cm of B, draw=none] {\footnotesize(1)};
    ...
    \scalebox{0.6}
    {
      \begin{tikzpicture}[->,>=stealth',node distance=1.5cm]
        ...
        \node[isosceles triangle, shape border rotate=90] (C11) [below=0cm of C1] {
          \begin{minipage}{1cm}
            {\footnotesize (1)} in\\Figure~\ref{example:op1}
          \end{minipage}
};
        ...
        \node[syntax] (C3) [below right=4cm and -1.5cm of C]{$\fA;\checkmark\paral(\checkmark\paral\checkmark)$};
