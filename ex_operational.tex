    ...
    \scalebox{0.6}
    {
      \begin{tikzpicture}[->,>=stealth',node distance=1.5cm]
        ...
        \node[syntax] (B) [below left=1cm of A] {$\checkmark\paral(\fB;\checkmark\paral
          \fC;\checkmark)$};
        \node[syntax] (C) [below left=7cm and -1cm of A] {$\fA;\checkmark\paral(\checkmark\paral
          \fC;\checkmark)$};
        ...
        \node[syntax] (B2) [left=1.5cm of B1] {$\checkmark\paral\fC;\checkmark$};
  ...
  \begin{minipage}{0.3\hsize}
    ...
    \scalebox{0.6}{%
      \begin{tikzpicture}[->,>=stealth',node distance=1.5cm]
        \node[syntax] (A)
        {$\checkmark\paral(\fB;\checkmark\paral\fC;\checkmark)$};
        \node[syntax] (B) [below left=1cm and 0cm of A]{$\checkmark\paral(\checkmark\paral\fC;\checkmark)$};
        \node[syntax] (C) [below right=1cm and 0cm of A]{$\checkmark\paral\fC;\checkmark$};
        \node[syntax] (D) [below left=7cm and 0cm of A]{$\checkmark\paral(\fB\checkmark\paral\checkmark)$};
        \node[syntax] (E) [below right=7cm and 0cm of A]{$\fB;\checkmark\paral\checkmark$};
