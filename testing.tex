...
\begin{figure}[h]
	...
	\begin{minipage}[b]{0.48\textwidth}
		...
		\caption{Feature models computing with probability of 20\% of having parallel operands.}\label{fig:plot:probs:boxplot}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.48\textwidth}
		\includegraphics[width=\textwidth]{boxplot_mem.eps}
		\caption{Memory usage graph for feature models with probability of 20\% of having parallel operands.}\label{fig:plot:probs:boxplotmem}
	\end{minipage}
\end{figure}
...
Figure~\ref{fig:plot:probs:boxplot} shows el grafico
...
Figure~\ref{fig:plot:probs:boxplotmem} shows the memory usage
in the mean time the algorithm is running.
...
\begin{figure}[h]
	...
	\begin{minipage}[b]{0.48\textwidth}
		...
		\caption{Feature models computing with probability of 1\% of having parallel operands.}\label{fig:plot:probs:boxplot_0_1}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.48\textwidth}
		\includegraphics[width=\textwidth]{boxplot_0_1_mem.eps}
		\caption{Memory usage graph for feature models with probability of 1\% of having parallel operands.}\label{fig:plot:probs:boxplot_0_1_mem}
	\end{minipage}
\end{figure}

Figure~\ref{fig:plot:probs:boxplot_0_1} shows
...
Figure~\ref{fig:plot:probs:boxplot_0_1} and Figure~\ref{fig:plot:probs:boxplot_0_1_mem} shows the
algorithm performance and memory usage having a probability of 1\% of finding a parallel operand.

Figure~\ref{fig:plot:probs:boxplot_0_5} and Figure~\ref{fig:plot:probs:boxplot_0_5_mem}shows the
algorithm performance and memory usage having a probability of 50\% of finding a parallel operand.
...
\begin{figure}[h]
	...
	\begin{minipage}[b]{0.48\textwidth}
		...
		\caption{Feature models computing with probability of 50\% of having parallel operands.}\label{fig:plot:probs:boxplot_0_5}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.48\textwidth}
		\includegraphics[width=\textwidth]{boxplot_0_5_mem.eps}
		\caption{Memory usage graph for feature models with probability of 50\% of having parallel operands.}\label{fig:plot:probs:boxplot_0_5_mem}
	\end{minipage}
\end{figure}
