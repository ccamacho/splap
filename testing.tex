...
was randomly generated using BeTTy~\cite{SeguraHBC11}.
...
probability of having optional features in the model and 0.2 for having mandatory features. The
sum of all probabilities must be 1. If no weight is configured all features and relationships will
have the same weight, which is 0.25.
