...
approach. In order to carry out this study, we have implemented the proposed probabilistic extension by a tool. The source code 
of this tool is available at the main project site.
\footnote{\url{http://simba.fdi.ucm.es/at/probabilistic/implementation_splap.tar}}
The simulations were executed based on the implementation of the denotational
semantics for the probabilistic extension. We have used a variability model consisting of 
...
It is important to remark that there is a small variation in the processing time for calculating the probability of each single feature. We think that his variation in mainly caused by the inherent noise of the node where the experiment is launched (e.g. disk latencies, operating
