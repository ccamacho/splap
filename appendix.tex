\appendix
\section{Results for the proof of Section~\ref{prop:DenoOpe}}\label{app:proofs}
...
\section{Results for the proof of Section~\ref{sec:stat:hidMain}}\label{appendixB}
