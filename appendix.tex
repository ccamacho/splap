...
\end{displaymath}
\begin{proof}
  The proof is made by induction on $|pr|$. The base case
  ($pr=\emptyset$) is immediate from the definitions.   So let assume
  ...
  \begin{equation}\label{eq:lempar1}
    ...
    \begin{displaymath}
      \begin{split}
        \calQ = \{ (pr', r)\ |\ (pr', r)\in\prodp(Q),\ \exists \fA\in
        \calF,pr'\subseteq\calF,r_{1},r_{2}:\\ P\tran{\fA}_{r_{1}} P',
