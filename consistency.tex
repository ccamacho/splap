...
derived in the probabilistic model can be also derived in the non probabilistic model. In addition, by Lemma~\ref{dfn:pr:sum} \mncomment{Que lema es este?} we know that any derived trace in the probabilistic model has a positive probability.
