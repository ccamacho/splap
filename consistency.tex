...
\bdfn
  ...
  \begin{displaymath}
     ...
     \begin{cases}
       ...
       \mncomment{arreglar esto} P & \mathrm{otherwise}
     \end{cases}
  \end{displaymath}
\mncomment{la traducci�n estaba mal, muy mal, vamos, fatal. Hay que aplicar np a $P$ y $Q$, asi que el otherwise hay que poner todos los casos}
\edfn
