...
\fodaPA\ syntax and the main operators usage for both the operational
and denotational semanctics.
Section \ref{sec:stat:sintaxMain} presents our probabilistic language \fodaPAp. Section \ref{sec:equivalenceMain} is used to prove the equivalence between the operational and denotational semantics. In section \ref{sec:stat:hidMain} we extend our language to define how sets of features can be hidden. Section~\ref{sec:stat:impl} presents an empirical study that has been carried out by using our implementation of the denotational semantics for the probabilistic extension. Finally, section~\ref{section:jstat:concs} presents our conclusions and some lnes of future work.
