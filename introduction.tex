...
\begin{itemize}
	...
	\item In order to show the applicability and scalability of our approach, a thorough empirical study, using different configurations to generate a wide-spectrum of variability models, has been carried out. These variability models have been generated using BeTTy~\cite{SeguraHBC11}.
...
in comparison with the denotational semantics implementations presented in previous works.
